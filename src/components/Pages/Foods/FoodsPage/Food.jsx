...
const Food = ({ food }) => {
    ...
    return (
        <div className='border w-[500px] mx-auto rounded-lg drop-shadow-xl bg-slate-50'>
            <div className='h-96'>
                {/* Food image */}
            ...
            <div className='flex justify-between px-3'>
                ...
                <div className='text-slate-800'>
                    ...
                    <p className='font-semibold my-4 text-xl'>Price: ${price}</p>
                </div>
                <div className='me-4'>
                    {/* react of customer */}
                    <span onClick={() => setLove(!love)}>
                        {
                            love ? <FaRegHeart className='w-7 h-7 font-thin' /> : <FaHeart className='w-7 h-7 text-red-600' />
                        }
                    </span>
                </div>
            </div>
