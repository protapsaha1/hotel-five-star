...
const Login = () => {
    ...
    return (
        <div className={theme === "light" ? 'bg-zinc-200 to-zinc-800 w-[100vw] h-full py-10' : 'bg-[#0f1929]  to-zinc-800 w-[100vw] h-full py-10'}>  {/* TODO make border colorful random color*/}
